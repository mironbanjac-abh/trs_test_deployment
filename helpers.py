...
def load_single_student_simulation_scores(df: pd.DataFrame, additional_stats: bool = True, window: int = 5) -> dict:
    """
    ...
    :return scores - Dictionary that contains final scores of the individual exam simulations
    """
...
def calculate_confidence_interval_t_distribution(m: float, std: float, n: int, df: int, confidence_level: float = 0.95):
    """
